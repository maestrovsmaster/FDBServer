...
public class GoodsCountServlet extends HttpServlet {
	...
	private JSONObject getCountGoods()
	{
		...
		int cnt  = query.getCountGoods();
		try {
			scanJson.put("cnt", cnt);
